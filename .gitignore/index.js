...
bot.on("message", async function(message) {
    ...
    if(!message.channel.id === botsalon) && (!message.channel.id === botsalon2) return message.channel.sendMessage("Cette commande ne peut être utilisé uniquement en " + botsalon.toString() + " :negative_squared_cross_mark:");
    ...
    switch (args[0].toLowerCase()) {
        ...
        break;
            ...
            .addField("z!ban", "Cette commande permet de bannir un utilisateur ! Pour l'utiliser, faites z!ban @(utilisateur) (raison)")
                ...
                .addField("z!play", "Jouer une musique ! N'oubliez pas le lien ! z!play <url youtube / nom de la musique>")
                .addField("z!skip", "Skip une musique !")
                .addField("z!stop", "Stop la musique !")
                .addField("z!volume", "Changer le volume de la musique ! z!volume <1 / 2 / 3 / 4 / 5>, si vous ne mettez pas de chiffre, le bot vous montrera le volume courent.")
                .addField("z!np", "Voir la musique en cours !")
                .addField("z!queue", "Voir les musiques dans la playlist !")
                .addField("z!pause", "Mettre la musique en pause !")
                .addField("z!unpause", "Relancer la musique !")
                .addField("z!userinfo", "Informations sur un utilisateur ! z!userinfo @(utilisateur)")
                .addField("z!serverinfo", "Informations sur le serveur !")
                .addField("z!photo", "Voir la photo de profil d'un utilisateur ! z!photo @(utilisateur)")
                .setColor("#01A9DB")
